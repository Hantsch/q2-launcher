 ...
 * name column takes whatever is left, the copy-address column right after it is a fixed-width
 * action cell with no header label, and the four data columns are fixed-width and right-aligned.
...
export const SERVER_LIST_GRID =
  'grid grid-cols-[minmax(0,1fr)_2.75rem_6rem_5.5rem_6.5rem_4.5rem] items-center gap-x-4 border-l-2 pr-4 pl-3'
