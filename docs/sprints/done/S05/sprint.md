...
- [x] 024 — Read the config in the launcher with Quake 2 syntax highlighting
- [x] 025 — Validation becomes Care — report, tidy-up actions and sync state in one place
